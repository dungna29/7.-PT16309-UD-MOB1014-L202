...
//        System.out.println(sv2.ten);
        System.out.println(sv1.getTen() + sv1.getMsv() + " FPOLY");
        System.out.println(sv2.getTen() + sv2.getMsv() + " FPOLY");
